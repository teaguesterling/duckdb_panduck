...
INTENTIONAL_GAPS = {
    ...
    "TYPE_PAGE": "physical pagination, added upstream 2026-08-31. THE EARLIER REASON "
                 "HERE WAS WRONG and is corrected 2026-09-01: it said no panduck source "
                 "exposes page boundaries because 'epub paginates by spine document'. "
                 "Spine items are DOCUMENT boundaries -- chapters -- and correctly are "
                 "not pages. But EPUB 3 has a real page construct, <span "
                 "epub:type=\"pagebreak\" title=\"42\"/>, carrying print-equivalent "
                 "pagination that citation and library workflows depend on. panduck "
                 "never reads epub:type at all, so those markers are DISCARDED. No "
                 "fixture contains one, which is why nothing noticed -- coverage real, "
                 "sample not. This is a genuine gap with a target now that "
                 "duck_blocks_page_rows exists upstream, not an absence of the "
                 "construct. NOTE: 'page_break' also collides "
